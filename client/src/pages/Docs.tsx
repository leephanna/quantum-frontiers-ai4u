...
# Contact: contact@ai4utech.com`}</pre>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3 text-gray-300">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-purple-400 font-semibold">Source Code</span>
                      <p className="text-sm text-gray-400">Available on request - contact@ai4utech.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full mt-2"></div>
